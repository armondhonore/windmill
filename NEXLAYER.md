...
**Live:** [https://relaxed-weasel-windmill.cloud.nexlayer.ai](https://relaxed-weasel-windmill.cloud.nexlayer.ai)  
...
**windmill** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: server
    ...
    - 8000
    vars:
      DATABASE_URL: "postgres://windmill:windmill@postgres.pod:5432/windmill"
      BASE_URL: "https://relaxed-weasel-windmill.cloud.nexlayer.ai"
      BASE_INTERNAL_URL: "http://server.pod:8000"
      MODE: "server"
